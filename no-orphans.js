...
const textFlyingContainer = document.querySelectorAll('.flying-container .text-bodycopy');
const textFooter = document.querySelector('.text-bodycopy-footer');

// Usage: Pass the elements directly
avoidOrphans(textFlyingContainer, textFooter);
